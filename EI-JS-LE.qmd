...
gtsave(table_gt, "response_table.png", expand = 20, vwidth = 1000, vheight = 600)

# insert the image 
cat("\\vspace{10mm}") # Add 10mm space above
knitr::include_graphics("response_table.png")
