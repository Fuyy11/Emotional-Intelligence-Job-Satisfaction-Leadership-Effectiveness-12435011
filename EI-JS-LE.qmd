...
plot1 <- ggplot(clean_data, aes(x = EI_Mean, y = LE_Mean)) + 
  ...
  labs(title = "Correlation between EI and LE", x = "EI Mean", y = "LE Mean") +
  theme_minimal() +
...
plot2 <- ggplot(clean_data, aes(x = EI_Mean, y = JS_Mean)) + 
  ...
  geom_smooth(method = "lm", color = "blue", se = FALSE) +
  stat_cor(method = "pearson", color = "black", label.x = 3, label.y = 4) +
  labs(title = "Correlation between EI and JS", x = "EI Mean", y = "JS Mean") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
...
plot3 <- ggplot(clean_data, aes(x = LE_Mean, y = JS_Mean)) + 
  ...
  geom_smooth(method = "lm", color = "blue", se = FALSE) +
  stat_cor(method = "pearson", color = "black", label.x = 3, label.y = 4) +
  labs(title = "Correlation between LE and JS", x = "LE Mean", y = "JS Mean") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))  
